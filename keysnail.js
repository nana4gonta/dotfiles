...
//{{%PRESERVE%
// ここにコードを入力して下さい
// Personaのtext-shadowを無効化
style.register(":-moz-lwtheme-brighttext, :-moz-lwtheme-darktext { text-shadow: none; !important }");
...
// KKK
plugins.options["kkk.sites"] = ["^https?://twitter\\.com/"];
...
plugins.options["K2Emacs.editor"] = "/Applications/Emacs-24.app";
plugins.options["K2Emacs.ext"] = "";
...
key.setViewKey([['a'], ['C-a']], function (ev, arg) {
    ext.exec("tanything", arg);
}, 'タブを一覧表示', true);
...
key.setCaretKey('C-a', function (ev, arg) {
    ext.exec("tanything", arg);
}, 'タブを一覧表示', true);
